...
class Devllo_Events_WC_Product_Data_Store_CPT extends WC_Product_Data_Store_CPT {
    ...
    public function read( &$product ) {
        ...
        if ( ! $product->get_id() || ! ( $post_object = get_post( $product->get_id() ) ) || ! in_array( $post_object->post_type, array( 'devllo_event', 'post' ) ) ) { 
    ...
    public function get_product_type( $product_id ) {
        ...
        if ( 'product_variation' === $post_type ) {
            return 'variation';
        } elseif ( in_array( $post_type, array( 'devllo_event', 'post' ) ) ) { 
